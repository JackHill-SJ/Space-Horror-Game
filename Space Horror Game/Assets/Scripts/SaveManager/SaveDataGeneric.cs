...
public class SaveDataGeneric<T>
{
	...
	[UnityEngine.SerializeField] [UnityEngine.HideInInspector] private T DirectValue;
	/// <summary>
	/// <para>Basic Declaration, sets the name to Unnamed variable.</para>
	/// </summary>
	public SaveDataGeneric(string _name) => name = _name;
	public SaveDataGeneric(string _name, T _value)
	{
		name = _name;
		if (SaveManager.GetData(name) == null) Value = _value;
	}
}